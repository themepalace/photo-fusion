<?php
/**
 * Photo Fusion customizer sanitization functions
 *
 ...
 */
function photo_fusion_sanitize_select( $input, $setting ) {
 ...
 */
function photo_fusion_sanitize_image( $image, $setting ) {
	/*
 ...
 *                    the setting default.
 */
function photo_fusion_sanitize_number_range( $number, $setting ) {
...
* @since Photo Fusion 0.1
*/
function photo_fusion_sanitize_page( $input ) {
 ...
 */
function photo_fusion_sanitize_checkbox( $checked ) {
 ...
 * @since Photo Fusion 0.1
 */
function photo_fusion_sanitize_custom_css( $input ) {
	if ( $input != '' ) {
 ...
 * @since Photo Fusion 0.1
 */
function photo_fusion_sanitize_category_list( $input ) {
	if ( $input != '' ) {
		$args = array(
						'type'			=> 'post',
						'child_of'      => 0,
...
if ( ! function_exists( 'photo_fusion_sanitize_footer_content' ) ) :
	 ...
	 */
	function photo_fusion_sanitize_footer_content( $input, $setting ) {
