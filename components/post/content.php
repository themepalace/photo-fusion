...
if ( ! function_exists( 'photo_fusion_post_content_part' ) ) :
	/**
	 * Header Codes
	 *
	 ...
	 *
	 */
	function photo_fusion_post_content_part( $int ) {
		// echo $int;
	if ( $int == 9 ) $int = 1;
		if ( $int == 1 || $int == 6 ) {
...
add_filter( 'photo_fusion_post_content_filter', 'photo_fusion_post_content_part', 10, 1 );
